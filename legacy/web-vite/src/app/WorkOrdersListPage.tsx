  ...
  return (
    <Box>
      <PageHeader
        ...
        actions={
          <Button variant="contained" onClick={() => navigate('/app/work-orders/new')}>
            Nueva orden
          </Button>
        }
      />
      ...
      {isLoading ? (
        ...
        <Panel>
          <EmptyState
            ...
            onAction={() => navigate('/app/work-orders/new')}
          />
        </Panel>
      ) : (
          ...
          {orders.map((order) => (
            <TableRow key={order.id} hover>
              ...
              <TableCell align="right">
                <Button size="small" onClick={() => navigate(`/app/work-orders/${order.id}`)}>
                  Ver
                </Button>
              </TableCell>
            </TableRow>
